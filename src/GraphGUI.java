...
public class GraphGUI extends JComponent {
    ...
    private static ArrayList<Node> buffer = new ArrayList<Node>();
    ...
    public static void main(String[] args) throws Exception {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                JFrame f = new JFrame("GraphGUI");
                f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                GraphGUI gp = new GraphGUI();
    ...
    private class ControlPanel extends JToolBar {
        ...
        private Action yeet = new YeetAction("Yeet");
    ...
    private class ColorAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            color = JColorChooser.showDialog(
                GraphGUI.this, "Choose a color", color);
            if (color != null) {
    ...
    private class YeetAction extends AbstractAction {
    	public YeetAction(String name) {
    		super(name);
    	}
    ...
    private static class Edge {
        ...
        private Node n1; //Start node
        private Node n2; //End node
